...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.moneyAchievs=[
		'Your so poor..',				1,
		'Now your getting it.',			100,
		'Your still trash tbh.....',	1000,
		'Firck you bro stop cheating',  10000,
		'Your using OpenSesame',				100000,
		'Your pretty popular..',			1000000,
		'Even aliens go there.',				10000000,
		'God now realites go there.',				100000000,
		'Oh my gawd', 			1000000000,
		'NVM', 				5000000000,
		...
		order=200;
		Game.cpsAchievs=[
		'Your fingers are dry',				1,
		'You are pretty pro',				10,
		'autoclicker kid.',			100,
		'now you coded your own autoclicker to make it super fast',				1000,
		'DAMNNNNNN',				10000,
		'sheeeeeehhhh',				100000,
		'Have you lost your breath',				1000000,
		'Cookie quasar',				10000000,
		'your room is flooded with just.... cookies',	100000000,
		'STOP IT YOUR GONNA NEED TO HAVE SURGERY',		1000000000
		];
		for (var i=0;i<Game.cpsAchievs.length/2;i++)
		{
			var pic=[i,5];
